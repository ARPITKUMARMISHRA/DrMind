                                    ...
                                    <div className="banner-content">
                                        <div className="banner-left">
                                            <div className="content-wrapper">
                                                ...
                                                <Link to="/quiz" className="btn btn-secondary" state={{ hint: true }}>Get Started</Link>
                                            </div>
                                        </div>
                                ...
                                <div className="container">
                                    <div className="services-content">
                                        ...
                                        <div className="services-list">
                                            <Link to='/quiz' className="services-item">
                                            ...
                                            <Link to='/chatbot' className="services-item">
                                                <div className="item-icon">
                                                    <img src="assets/images/service-icon-2.png" alt="service icon" />
                                                </div>
                                                <h5 className="item-title fw-7">Chatbot Companion</h5>
                                                <p className="text">Your personal mental health companion: our chatbot is here to lend a listening ear and offer practical solutions.</p>
                                            </Link>
